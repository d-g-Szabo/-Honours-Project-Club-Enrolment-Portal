...
export default function BookingsPage() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '20px', fontSize: '24px', fontWeight: 'bold' }}>My Bookings</h2>
      <ul style={{ listStyleType: 'none', padding: 0 }}>
        {bookings.map((booking) => (
          <li key={booking.id} style={{
            ...
            <p style={{ margin: '0 0 10px 0', color: '#555' }}><b>Club Name:</b> {booking.sessions.users.full_name}</p>
